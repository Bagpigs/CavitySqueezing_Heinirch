...
omegaZ=2*pi*1.09*1e6; % Zeemansplitting in Hz
...
for nn=1:length(n_list)
    ...
    switch SeedType
        ...
        phi_initial(1,1)=phi_initial(1,1)+ 0.5*normrnd(0,1)+ 1i*0.5*normrnd(0,1);
        phi_initial(1,2)=phi_initial(1,2)+ 0.5*normrnd(0,1)+ 1i*0.5*normrnd(0,1);
        phi_initial(1,3)=phi_initial(1,3)+ 0.5*normrnd(0,1)+ 1i*0.5*normrnd(0,1);
        phi_initial(1,4)=phi_initial(1,4)+ 0.5*normrnd(0,1)+ 1i*0.5*normrnd(0,1);
        phi_initial(1,5)=phi_initial(1,5)+ 0.5*normrnd(0,1)+ 1i*0.5*normrnd(0,1);
        phi_initial(1,6)=phi_initial(1,6)+ 0.5*normrnd(0,1)+ 1i*0.5*normrnd(0,1);
